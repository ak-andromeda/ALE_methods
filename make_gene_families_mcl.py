...
def write_cluster_fasta_files(seq_dict, gene_family_dict):
    ...
    for name, gene_family in gene_family_dict.items():
        ...
        f = open("MCL_gene_families/"+file_name,"w")
...
def clean():
    ...
    os.system("mv " + mcl + " Input_files")
    os.system("mv " + data + " Input_files")
    print("\nScript finished - all clusters in MCL_gene_families directory")
    print("\nInput files are in the 'Input_files' directory")
    print("\n******************************************************************")
